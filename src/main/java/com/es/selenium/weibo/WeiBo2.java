...
public class WeiBo2 extends Concert{
    public static String loginUrl="https://weibo.com/at/comment?leftnav=1&wvr=6&nofilter=1";
    ...
    public  void login(WeiBo2 weiBo) throws InterruptedException {
        driver.get(weiBo.getLoginUrl());
        if(!new File("weibo2_cookie.txt").exists()){
            System.out.println("未登录");
            driver.findElementById("loginname").sendKeys("13548329849");
        ...
        while (true) {
            if (flag) {
                ...
                replay = choose("//*[@id='v6_pl_content_myatcommentlist']/div[4]/div/div[2]/div/ul/li[2]/a/span/span");
                replay.click();
                driver.findElementByXPath("//*[@id='v6_pl_content_myatcommentlist']/div[4]/div/div[3]/div/div/div[2]/div[1]/textarea").sendKeys("胡春杨好帅✖" + i++);
            }
            WebElement submit = choose("//*[@id='v6_pl_content_myatcommentlist']/div[4]/div/div[3]/div/div/div[2]/div[2]/div[1]/a");
    ...
    public void saveCooike(){
        try {
            ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream("weibo2_cookie.txt"));
    ...
    public void getCookies(){
        ...
        try {
            FileInputStream fis = new FileInputStream("weibo2_cookie.txt");
